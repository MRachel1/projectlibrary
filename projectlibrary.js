...
// window.onload = function () {
  document.addEventListener("DOMContentLoaded", function(){
    addBookToLibrary(`The Scars of Eden`, `Paul Wallis`, `200`, true,);
    addBookToLibrary(`Journey of souls`, `Michael Newton`, `278`, true);
    addBookToLibrary(`Decipher`, `Stel Pavlou`, `592`, false);
});
